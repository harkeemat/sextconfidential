...
class _ConferenceButtonBarState extends State<ConferenceButtonBar>
    with AfterLayoutMixin<ConferenceButtonBar> {
  ...
  void afterFirstLayout(BuildContext context) {
    final renderBoxButtonBar =
        _keyButtonBarHeight.currentContext!.findRenderObject() as RenderBox;
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          CircleButton(
            ...
            child: Icon(speakerOn ? Icons.speaker : Icons.volume_mute,
                color: Colors.white),
          ),
          if (hasFlash)
            CircleButton(
              ...
              child: Icon(flashEnabled ? Icons.highlight_off : Icons.highlight,
                  color: Colors.white),
            )
        ],
      ),
