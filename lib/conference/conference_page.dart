...
import '../shared/widgets/noise_box.dart';
...
class _ConferencePageState extends State<ConferencePage> {
  ...
  void _connectToRoom() async {
    try {
      print("coneccttt${widget.roomModel.token}");
      final conferenceRoom = ConferenceRoom(
        name: widget.roomModel.name.toString(),
        token: widget.roomModel.token.toString(),
        identity: widget.roomModel.identity.toString(),
      );
      //print("coneccttt$conferenceRoom");
