...
import '/pojo/Chatmediapojo.dart';
...
class UserprofileScreenState extends State<UserprofileScreen> {
  ...
  Future<void> favourite(int status) async {
    ...
    var response = await http
        .post(Uri.parse(Networks.baseurl + Networks.favorite), body: data);
  ...
  Future<void> hideuser() async {
    ...
    var jsonResponse;
    var response = await http
        .post(Uri.parse(Networks.baseurl + Networks.chathide), body: data);
    jsonResponse = json.decode(response.body);
    print("jsonResponse:-$jsonResponse");
    if (response.statusCode == 200) {
      if (jsonResponse["status"] == false) {
  ...
  Future<void> blockuser() async {
    ...
    var jsonResponse;
    var response = await http
        .post(Uri.parse(Networks.baseurl + Networks.chatblock), body: data);
    jsonResponse = json.decode(response.body);
    print("jsonResponse:-$jsonResponse");
    if (response.statusCode == 200) {
      if (jsonResponse["status"] == false) {
  ...
  Future<void> reportuser() async {
    ...
    var jsonResponse;
    var response = await http
        .post(Uri.parse(Networks.baseurl + Networks.chatreport), body: data);
    jsonResponse = json.decode(response.body);
    print("jsonResponse:-$jsonResponse");
    if (response.statusCode == 200) {
      if (jsonResponse["status"] == false) {
  ...
  Future<void> usermedialisting() async {
    ...
    var jsonResponse;
    var response = await http
        .post(Uri.parse(Networks.baseurl + Networks.chatmedia), body: data);
    jsonResponse = json.decode(response.body);
    print("jsonResponse:-$jsonResponse");
    if (response.statusCode == 200) {
      if (jsonResponse["status"] == false) {
