  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          StringConstants.deactivateacccount,
          style: TextStyle(
              fontSize: 14.sp,
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  StringConstants.reasonforleaving,
                  style: TextStyle(
                      fontSize: 12.sp,
                      fontFamily: "PulpDisplay",
                      fontWeight: FontWeight.w500,
                ...
                SizedBox(
                  ...
                  child: CustomDropdownButton2(
                    buttonDecoration: BoxDecoration(
                        ...
                        border:
                            Border.all(color: Appcolors().logintextformborder),
                ...
                Container(
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      filled: true,
                      fillColor: Appcolors().backgroundcolor,
                      hintText: StringConstants.reasonofleavening,
                      hintStyle: TextStyle(
                        decoration: TextDecoration.none,
                        fontWeight: FontWeight.w400,
                        fontSize: 12.sp,
              ...
              content: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      StringConstants.alertdialogmessage,
                      style: TextStyle(
                          fontSize: 14.sp,
                          height: 0.2.h,
                          // fontFamily: "PulpDisplay",
